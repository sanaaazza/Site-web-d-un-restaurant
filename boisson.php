...
<body>
    <header><img src="logo2-removebg-preview.png" alt="icon" id="logo1">
        <h1 id="tit1">Il Mago <br>
            Chef   </h1>
            <nav>
              <a href="resturant.html" id="t1">ACCUEIL</a>
          ...
          <div class="gallery">
            <img class="image1" src="jus.png" alt="Image 1">
            <img class="image2" src="za3za3.png" alt="Image 2">
            <img class="image3" src="milk.jpg" alt="Image 2">
            <div class="ligne-separable3"></div>
          </div>
          <div class="container">
            <div class="col">
                <img src="Boisson1.png" id="image">
            </div>
            <div class="col">
                <img src="Boissonmenu.png" id="image">
            </div>
            <div class="col">
                <img src="milkshakenewcopie.png" alt="" id="image">
            </div>
</body>
</html>
...
<head>
    ...
    <style>
     ...
     nav{display: flex; margin-top: 40px; position: absolute; margin-left: 700px;}
        ...
        .ligne-separable1 {position: absolute; margin-left:-6px; margin-top: 100px;
    width: 99.7%;
...
<body>
    <header><img src="logo2-removebg-preview.png" alt="icon" id="logo1">
        ...
        <div class="ligne-separable1"></div></header>
        <div class="gallery">
          <img class="image1" src="breakfastamer.jpg" alt="Image 1">
          <img class="image2" src="moroccanbreak.jpg" alt="Image 2">
          <img class="image3" src="sade-turkish-breakfast.jpg" alt="Image 2">
          <div class="ligne-separable3"></div>
        </div>
          <div class="container">
            <div class="col">
                <img src="breakfastcopie.png" id="image">
            </div>
            <div class="col">
                <img src="petitdéjeunercopie.png" id="image">
            </div>
            <div class="col">
                <img src="omelettenew.png" alt="" id="image">
            </div>
        </div>

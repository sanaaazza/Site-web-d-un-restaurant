...
<body>
    <header><img src="logo2-removebg-preview.png" alt="icon" id="logo1">
        <h1 id="tit1">Il Mago <br>
          ...
          </nav><div class="ligne-separable1"></div>
          </header>
          <div class="gallery">
            <img class="image1" src="tanjiya.jpg" alt="Image 1">
            <img class="image2" src="nicoise.jpg" alt="Image 2">
            <img class="image3" src="rfissa.jpg" alt="Image 2">
            <div class="ligne-separable3"></div>
          </div>
          <div class="container">
            <div class="col">
                <img src="repas facecopie.png" id="image">
            </div>
            <div class="col">
                <img src="repasQuetidiennenewcopie.png" id="image">
            </div>
            <div class="col">
                <img src="salade.png" alt="" id="image">
            </div>
</body>
</html>
...
<body>
    <header><img src="logo2-removebg-preview.png" alt="icon" id="logo1">
        <h1 id="tit1">Il Mago <br>
          ...
          <div class="gallery">
            <img class="image1" src="pizzaitalie.jpg" alt="Image 1">
            <img class="image2" src="pate.jpg" alt="Image 2">
            <img class="image3" src="emince.jpg" alt="Image 2">
            <div class="ligne-separable3"></div>
          </div>
          <div class="container">
            <div class="col">
                <img src="fast food.png" id="image">
            </div>
            <div class="col">
                <img src="fastfoodmenunew.png" id="image">
            </div>
            <div class="col">
                <img src="PATEPIZZATACOS1.png" alt="" id="image">
            </div>
        </div>
</body>
</html>